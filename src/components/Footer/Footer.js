      ...
      <MDBContainer className="text-center text-md-left">
        <MDBRow className="text-center text-md-left mt-3 pb-3">
          ...
          <MDBCol md="4" lg="3" xl="3" className="mx-auto mt-3">
            ...
            <p>
              <i className="fa fa-envelope mr-3" />nitin3.ak@outlook.com
            </p>
            <p>
              <i className="fa fa-phone mr-3" /> +91 9730677940
            </p>
            <p>
              <i className="fa fa-home mr-3" /> Nitin Test
            </p>
          </MDBCol>
        </MDBRow>
        <hr />
